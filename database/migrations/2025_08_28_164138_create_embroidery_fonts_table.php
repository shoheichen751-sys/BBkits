...
return new class extends Migration
{
    ...
    {
        Schema::create('embroidery_fonts', function (Blueprint $table) {
            $table->id();
            $table->string('name'); // Nome da fonte (Arial, Times New Roman, etc.)
            $table->string('display_name'); // Nome para exibição
            $table->text('description')->nullable(); // Descrição da fonte
    ...
    {
        Schema::dropIfExists('embroidery_fonts');
    }
};
