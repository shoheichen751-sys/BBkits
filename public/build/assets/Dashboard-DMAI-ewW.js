import{J as j,r as N,j as e,Q as w}from"./app-DonCCsSR.js";import{A as y}from"./AuthenticatedLayout-B1B5B2NI.js";import{S as k}from"./SalesModal-Cr3m7kho.js";import{R as F}from"./RankingDisplay-C8OsxWJI.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-ARaz8VQE.js";import"./x-DD9w5lUe.js";import"./createLucideIcon-ClbHDne_.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
