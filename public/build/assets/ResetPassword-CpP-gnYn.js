import{x as p,j as e,Q as f,t as n,V as l}from"./app-BuZxdkQ6.js";import"./TextInput-BWQevFww.js";/* empty css            */function j({token:d,email:c}){const{data:r,setData:t,post:m,processing:o,errors:s,reset:x}=p({token:d,email:c,password:"",password_confirmation:""}),u=a=>{a.preventDefault(),m(route("password.store"),{onFinish:()=>x("password","password_confirmation"),onSuccess:()=>{l.success("Senha redefinida com sucesso!")},onError:i=>{Object.keys(i).forEach(h=>{l.error(i[h])})}})};return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"Redefinir Senha - BBKits"}),e.jsx("style",{children:`
