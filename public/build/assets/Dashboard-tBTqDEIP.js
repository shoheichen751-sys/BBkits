import{J as g,r as b,j as e,Q as f}from"./app-d02xACaL.js";import{A as u}from"./AuthenticatedLayout-H-ecHZ0k.js";import{S as v}from"./SalesModal-CYjelh21.js";import{R as m}from"./RankingDisplay-BfkqtOJE.js";import{f as t}from"./currency-Ct0iAvPU.js";/* empty css            */import"./transition-BcKIHXMM.js";import"./x-BAXvJH7t.js";import"./createLucideIcon-BGI96u6F.js";function B(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
