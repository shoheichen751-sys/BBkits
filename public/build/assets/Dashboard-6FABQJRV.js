import{J as j,r as N,j as e,Q as w}from"./app-Z5jD7EM8.js";import{A as y}from"./AuthenticatedLayout-C3tggoLp.js";import{S as k}from"./SalesModal-CwoIOps9.js";import{R as F}from"./RankingDisplay-Bary6t7Z.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-yU0kzXfW.js";import"./x-CsQ0Pnpg.js";import"./createLucideIcon-CWZ4E3Jt.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
