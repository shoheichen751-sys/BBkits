import{J as g,r as b,j as e,Q as f}from"./app-VoDeNzPT.js";import{A as u}from"./AuthenticatedLayout-BYTpjYcl.js";import{S as v}from"./SalesModal-By4UqFd_.js";import{R as m}from"./RankingDisplay-Dh58nmeo.js";import{f as t}from"./currency-Ct0iAvPU.js";/* empty css            */import"./transition-_AUKL_ZA.js";import"./x-BVJ4tl5r.js";import"./createLucideIcon-Dyn3Fri4.js";function B(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
