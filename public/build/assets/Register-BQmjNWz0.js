import{x as u,j as e,Q as p,t as i,V as l}from"./app-B9VVVSEA.js";import"./TextInput-wnLw2lAV.js";function f(){const{data:s,setData:t,post:d,processing:o,errors:r,reset:c}=u({name:"",email:"",password:"",password_confirmation:""}),m=a=>{a.preventDefault(),d(route("register"),{onFinish:()=>c("password","password_confirmation"),onSuccess:()=>{l.success("Conta criada com sucesso!")},onError:n=>{Object.keys(n).forEach(x=>{l.error(n[x])})}})};return e.jsxs(e.Fragment,{children:[e.jsx(p,{title:"Cadastro - BBKits"}),e.jsx("style",{children:`
