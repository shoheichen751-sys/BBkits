import{J as g,r as b,j as e,Q as f}from"./app-B9VVVSEA.js";import{A as u}from"./AuthenticatedLayout-DiFUHcnr.js";import{S as v}from"./SalesModal-DbryoXos.js";import{R as m}from"./RankingDisplay-DCK1uZy9.js";import{f as t}from"./currency-Ct0iAvPU.js";import"./transition-C9zKMQRq.js";import"./x-DZctNJ0M.js";import"./createLucideIcon-DAdPBed7.js";function M(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
