import{j as e,Q as x}from"./app-BUVQdhLm.js";import{A as m}from"./AuthenticatedLayout-Dn41uJ2q.js";/* empty css            */import"./transition-pGTmuh3c.js";function j({sale:t}){const l=a=>{const r={pendente:{bg:"bg-gradient-to-r from-yellow-100 to-yellow-200",text:"text-yellow-800",border:"border-yellow-300",icon:"⏳",glow:"shadow-yellow-200"},aprovado:{bg:"bg-gradient-to-r from-green-100 to-green-200",text:"text-green-800",border:"border-green-300",icon:"✅",glow:"shadow-green-200"},recusado:{bg:"bg-gradient-to-r from-red-100 to-red-200",text:"text-red-800",border:"border-red-300",icon:"❌",glow:"shadow-red-200"},cancelado:{bg:"bg-gradient-to-r from-gray-100 to-gray-200",text:"text-gray-800",border:"border-gray-300",icon:"⚪",glow:"shadow-gray-200"},estornado:{bg:"bg-gradient-to-r from-purple-100 to-purple-200",text:"text-purple-800",border:"border-purple-300",icon:"🔄",glow:"shadow-purple-200"}},c={pendente:"Pendente",aprovado:"Aprovada",recusado:"Recusada",cancelado:"Cancelada",estornado:"Estornada"},s=r[a]||r.pendente;return e.jsxs("span",{className:`inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-bold ${s.bg} ${s.text} border-2 ${s.border} ${s.glow} shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105`,children:[e.jsx("span",{className:"text-lg",children:s.icon}),c[a]]})},i=a=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(a),o=a=>new Date(a).toLocaleDateString("pt-BR"),d=a=>new Date(a).toLocaleString("pt-BR"),n=(a=>({pix:{label:"PIX",icon:"🔗"},boleto:{label:"Boleto Bancário",icon:"📄"},cartao:{label:"Cartão de Crédito/Débito",icon:"💳"},dinheiro:{label:"Dinheiro",icon:"💰"}})[a]||{label:a,icon:"💳"})(t.payment_method);return e.jsxs(e.Fragment,{children:[e.jsx(x,{title:`Venda #${t.id} - BBKits`}),e.jsx("style",{children:`
