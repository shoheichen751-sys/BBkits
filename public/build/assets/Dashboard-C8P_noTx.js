import{J as j,r as N,j as e,Q as w}from"./app-c7lZbUDR.js";import{A as y}from"./AuthenticatedLayout-DI8Yv17-.js";import{S as k}from"./SalesModal-BJqzzsHb.js";import{R as F}from"./RankingDisplay-CtS-pLIg.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-JQWz5UxG.js";import"./x-D3nItqId.js";import"./createLucideIcon-BM8il3R7.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
