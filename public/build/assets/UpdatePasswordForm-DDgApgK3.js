import{r as d,x,j as a}from"./app-KKRE7lVv.js";import"./TextInput--SVTjNdo.js";import{z as g}from"./transition-DGVTEXBA.js";/* empty css            */function y({className:p=""}){const i=d.useRef(),l=d.useRef(),{data:t,setData:o,errors:s,put:m,reset:n,processing:c,recentlySuccessful:f}=x({current_password:"",password:"",password_confirmation:""}),u=e=>{e.preventDefault(),m(route("password.update"),{preserveScroll:!0,onSuccess:()=>n(),onError:r=>{r.password&&(n("password","password_confirmation"),i.current.focus()),r.current_password&&(n("current_password"),l.current.focus())}})};return a.jsxs(a.Fragment,{children:[a.jsx("style",{children:`
