import{x as u,r as g,V as s,j as e,Q as h,t as l}from"./app-B9VVVSEA.js";import"./TextInput-wnLw2lAV.js";function w({status:o,canResetPassword:d}){const{data:n,setData:i,post:m,processing:c,errors:r,reset:x}=u({email:"",password:"",remember:!1});g.useEffect(()=>{o&&s.success(o)},[o]);const p=a=>{a.preventDefault(),m(route("login"),{onFinish:()=>x("password"),onSuccess:()=>{s.success("Login realizado com sucesso!")},onError:t=>{t.email&&s.error(t.email),t.password&&s.error(t.password)}})};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Entrar - BBKits"}),e.jsx("style",{children:`
