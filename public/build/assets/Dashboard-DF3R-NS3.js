import{J as j,r as N,j as e,Q as w}from"./app-C2QBsWo0.js";import{A as y}from"./AuthenticatedLayout-aiuFKSRL.js";import{S as k}from"./SalesModal-BEilykee.js";import{R as F}from"./RankingDisplay-CpZ7-chQ.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-DrEPseAf.js";import"./x-rBg-YcJI.js";import"./createLucideIcon-Dj8-Fqf7.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
