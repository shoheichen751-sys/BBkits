import{J as j,r as N,j as e,Q as w}from"./app-Beeavjss.js";import{A as y}from"./AuthenticatedLayout-BD-epMCk.js";import{S as k}from"./SalesModal-BXVpJR1K.js";import{R as F}from"./RankingDisplay-eBFdpWi7.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-CYrxGgVn.js";import"./x-jPea749O.js";import"./createLucideIcon-DpBy_BuL.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
