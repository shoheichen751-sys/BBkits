import{J as j,r as N,j as e,Q as w}from"./app-DNWFTRXU.js";import{A as y}from"./AuthenticatedLayout-CAi6FE80.js";import{S as k}from"./SalesModal-hFb-3SMw.js";import{R as F}from"./RankingDisplay-uc3URLCF.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-lv-18lzG.js";import"./x-Ci4BNZdq.js";import"./createLucideIcon-BfSm_yfr.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
