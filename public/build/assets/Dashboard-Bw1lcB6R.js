import{J as h,r as p,j as e,Q as g}from"./app-D-frthTF.js";import{A as b}from"./AuthenticatedLayout-O7e7q4XU.js";import{S as u}from"./SalesModal-DkRjYHNe.js";import{R as f}from"./RankingDisplay-D03cmwp-.js";/* empty css            */import"./transition-CR2LWAWH.js";import"./x-49NkZGlW.js";import"./createLucideIcon-B_5zSipQ.js";const s=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function C(){var o;const{auth:l,gamification:r,salesData:t,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:t,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
