import{J as j,r as N,j as e,Q as w}from"./app-Cmb5E3M6.js";import{A as y}from"./AuthenticatedLayout-8DQT0xZj.js";import{S as k}from"./SalesModal-C50249kg.js";import{R as F}from"./RankingDisplay-qh9Ivf0g.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-B6jIjHDs.js";import"./x-aZXmNox6.js";import"./createLucideIcon-v66rPcK_.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
