import{J as j,r as N,j as e,Q as w}from"./app-B1ZS_QuH.js";import{A as y}from"./AuthenticatedLayout-CM_xjbvk.js";import{S as k}from"./SalesModal-CHcveZKc.js";import{R as F}from"./RankingDisplay-C2tEJnu4.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-DXKGdKZB.js";import"./x-pBJt4lqa.js";import"./createLucideIcon-CKDK-cGz.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
