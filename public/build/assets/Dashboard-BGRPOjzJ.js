import{J as g,r as b,j as e,Q as f}from"./app-BuZxdkQ6.js";import{A as u}from"./AuthenticatedLayout-CAy3-WEW.js";import{S as v}from"./SalesModal-bOE7Dbjx.js";import{R as m}from"./RankingDisplay-qf6X_vNb.js";import{f as t}from"./currency-Ct0iAvPU.js";/* empty css            */import"./transition-BeVkB4Es.js";import"./x-H2pI77AV.js";import"./createLucideIcon-DSuQbmke.js";function B(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
