import{x as p,j as e,Q as u,t as i,V as l}from"./app-CmoxjNKf.js";import"./TextInput-d49xFqvL.js";/* empty css            */function b(){const{data:s,setData:t,post:d,processing:o,errors:r,reset:c}=p({name:"",email:"",password:"",password_confirmation:""}),m=a=>{a.preventDefault(),d("/register",{onFinish:()=>c("password","password_confirmation"),onSuccess:()=>{l.success("Conta criada com sucesso!")},onError:n=>{Object.keys(n).forEach(x=>{l.error(n[x])})}})};return e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"Cadastro - BBKits"}),e.jsx("style",{children:`
